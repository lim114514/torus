...
public class Turret extends Structure {
    ...
    static PartModelTemplate MODEL_HEAD = new PartModelTemplate("head");
    static {
        MODEL_HEAD.add(new PartModelElementItemDisplayRenderer(Material.GRAY_CONCRETE, 0f, 1.375f, 0f, .375f, .375f, .3125f));
        MODEL_HEAD.add(new PartModelElementItemDisplayRenderer(Material.GRAY_CONCRETE, 0f, 1.375f, 0f, .25f, .25f, .9375f));
        MODEL_HEAD.add(new PartModelElementItemDisplayRenderer(Material.GRAY_CONCRETE, 0f, 1.375f, -.125f - .5f, .125f, .125f, .9375f));
        MODEL_HEAD.add(new PartModelElementItemDisplayRenderer(Material.GRAY_CONCRETE, 0f, 1.125f, 0f, .1875f, .1875f, .1875f));
        MODEL_HEAD.add(new PartModelElementItemDisplayRenderer(Material.CYAN_TERRACOTTA, 0f, 1.578125f, 0f, .25f, .0625f, .1875f));
        MODEL_HEAD.add(new PartModelElementItemDisplayRenderer(Material.CYAN_TERRACOTTA, .3125f - .5f, 1.375f, 0f, .0625f, .125f, .1875f));
...
//        MODEL_HEAD.add(new ModelPartItemDisplayRenderer(Material.CHAIN, .25f, .8125f, 0f, .3125f, .5625f, .375f, 90, 0));
    ...
    static {
        ...
        MODEL_BASE.add(new PartModelElementItemDisplayRenderer(Material.CYAN_TERRACOTTA, 0f, .75f, 0f, .125f, 1.3125f, .125f));

        // Cables
        MODEL_BASE.add(new PartModelElementItemDisplayRenderer(Material.GRAY_CONCRETE, .458125f - .5f, .5625f, .125f, .0625f, .875f, .0625f));
...
//        MODEL_BASE.add(new ModelPartItemDisplayRenderer(Material.LIGHT_GRAY_TERRACOTTA, .04875f, .5f, .25f, .0625f, .0625f, .3125f));
        ...
        // Power connector
        MODEL_BASE.add(new PartModelElementItemDisplayRenderer(Material.GRAY_CONCRETE, 0f, .0625f, 0f, .75f, .125f, .75f));
