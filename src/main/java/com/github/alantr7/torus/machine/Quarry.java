...
public class Quarry extends Structure {
    ...
    static PartModelTemplate MODEL_ENERGY_CONNECTOR = new PartModelTemplate();
    static {
    ...
    static PartModelTemplate MODEL_ITEM_CONNECTOR = new PartModelTemplate();
    static {
    ...
    static PartModelTemplate MODEL_DRILL_HOLDER = new PartModelTemplate();
    static {
    ...
    static PartModelTemplate MODEL_DRILL = new PartModelTemplate();
    static {
    ...
    static PartModelTemplate MODEL_DRILL_TIP = new PartModelTemplate();
    static {
    ...
    static PartModelTemplate MODEL_MOVER_X = new PartModelTemplate();
    static {
    ...
    static PartModelTemplate MODEL_MOVER_Z = new PartModelTemplate();
    static {
