...
public class CoalGenerator extends Structure {
    ...
    static {
        ...
        MODEL.add(new PartModelElementItemDisplayRenderer(Material.END_ROD, new Vector3f(.125f - .5f, .625f, .0625f), new Vector3f(1f, .5f, 1f), 90f, 90f));
        ...
        MODEL.add(new PartModelElementItemDisplayRenderer(Material.END_ROD, new Vector3f(.125f - .5f, .625f, .4375f), new Vector3f(1f, .5f, 1f), 90f, 90f));
        ...
        MODEL.add(new PartModelElementItemDisplayRenderer(Material.END_ROD, new Vector3f(.125f - .5f, .625f, .8125f), new Vector3f(1f, .5f, 1f), 90f, 90f));
