...
public class OreWasher extends Structure {
    ...
    static PartModelTemplate MODEL_CONNECTOR_ITEMS_IN = new PartModelTemplate();
    static {
    ...
    static PartModelTemplate MODEL_CONNECTOR_POWER = new PartModelTemplate();
    static {
    ...
    static PartModelTemplate MODEL_WATER_IN = new PartModelTemplate();
    static {
    ...
    static PartModelTemplate MODEL_CONNECTOR_ITEMS_OUT = new PartModelTemplate();
    static {
