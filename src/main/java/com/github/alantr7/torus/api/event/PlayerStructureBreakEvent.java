...
@Getter
public class PlayerStructureBreakEvent extends Event implements Cancellable {
    ...
    public PlayerStructureBreakEvent(TorusPlayer player, StructureInstance structure) {
        this.player = player;
